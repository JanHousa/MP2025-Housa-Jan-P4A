...
## Tvorba kvízu
![CreateQuiz](sources/CreateQuiz.gif)
## Vytvoření lobby
![CreateQuiz](sources/CreateLobby.gif)
## Připojení do lobby
![CreateQuiz](sources/JoinLobby.gif)
## Spuštění hry
![CreateQuiz](sources/Game.gif)
...
![Database_Diagram](sources/Database_Diagram.svg)
